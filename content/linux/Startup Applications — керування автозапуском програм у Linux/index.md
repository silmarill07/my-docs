---
title: "Startup Applications — керування автозапуском програм у Linux"
date: 2026-07-07
draft: false
tags: ["linux", "applications"]
image: "1.png"
description: "Огляд утиліти Startup Applications, яка дозволяє керувати програмами, що запускаються автоматично після входу в систему."
slug: "startup-applications-linux"
---

**Startup Applications** — це проста утиліта для керування програмами, які автоматично запускаються після входу користувача в систему. Вона надає зручний графічний інтерфейс для перегляду, додавання та налаштування елементів автозапуску.

> [!NOTE]
> Утиліта особливо корисна, якщо потрібно швидко налаштувати автозапуск без редагування `.desktop`-файлів вручну.

## Основні можливості

* перегляд усіх програм, які запускаються під час входу в систему;
* додавання нових програм до автозапуску;
* редагування наявних записів;
* увімкнення або вимкнення автозапуску окремих програм;
* видалення непотрібних записів;
* встановлення затримки перед запуском програми;
* зручний пошук встановлених програм під час додавання нового запису.

> [!TIP]
> Використання затримки запуску допомагає зменшити навантаження на систему одразу після входу в обліковий запис, особливо якщо автоматично запускається багато програм.

## Коли варто використовувати

Startup Applications стане у пригоді, якщо потрібно:

* автоматично запускати месенджери, VPN або хмарні сервіси;
* відкривати певні програми після входу в систему;
...
Startup Applications — це невелика, але дуже корисна утиліта, яка значно спрощує керування автозапуском програм у Linux та позбавляє необхідності вручну редагувати системні файли.