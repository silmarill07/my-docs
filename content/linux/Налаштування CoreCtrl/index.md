...
> [!NOTE]
> Наведена команда підходить для Fedora. Для інших дистрибутивів шлях до `.desktop`-файлу може відрізнятися.
...
> [!TIP]
> Усі актуальні команди та особливості налаштування для різних дистрибутивів можна знайти в офіційній документації <a href="https://gitlab.com/corectrl/corectrl/-/wikis/Setup" target="_blank" rel="noopener noreferrer">CoreCtrl</a>.
